		...
		where TContext : DbContext
	{
		...
		public override void Save( TBusinesEntity entity )
		{
			...
			if ( targetEntity == null )
			{
				...
				( DataContext as IObjectContextAdapter ).ObjectContext.AttachByIdValue<TStorageEntity>( targetEntity );
			}
		...
		public override void Delete( TBusinesEntity entity )
		{
			using ( var enumerator = Table.GetEnumerator() )
			{
				...
				if ( sEntity != null )
				{
					...
					( DataContext as IObjectContextAdapter ).ObjectContext.DeleteObject( sEntity );
				}
			}
		}
