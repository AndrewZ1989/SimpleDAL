...
{
    internal class EFUnitOfWork<TContext> : IUnitOfWork where TContext : DbContext
	{
		#region .ctor
		...
		public ITransaction BeginTransaction( IsolationLevel isolationLevel )
		{
			...
			var transaction = _entityFrameworkContext.Context.Database.Connection.BeginTransaction( isolationLevel );
			_entityFrameworkContext.Context.Database.UseTransaction( transaction );
